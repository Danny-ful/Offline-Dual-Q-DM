...
# Expert data paths
export EXPERT_PATH="/home/ubuntu/shengyifei/lwq/experts/hopper.pkl"
export SUPPLEMENT_PATH="/home/ubuntu/shengyifei/lwq/supplement/hopper_medium_expert-v2.pkl"
...
SWEEP_CONFIG="${SWEEP_CONFIG:-scripts/wandb_sweep_hopper.yaml}"
SWEEP_LOG="${SWEEP_LOG:-scripts/sweep_ids_hopper.log}"
EXISTING_SWEEP_ID="${EXISTING_SWEEP_ID:-}"
AUTO_REUSE_SWEEP="${AUTO_REUSE_SWEEP:-1}"
SWEEP_STATE_FILE="${SWEEP_STATE_FILE:-scripts/.sweep_state_hopper.env}"
