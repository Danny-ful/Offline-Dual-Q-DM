...
ENV_NAME="${ENV_NAME:-cheetah}"
ENV_DEMO="${ENV_DEMO:-halfcheetah_full_replay-v2.pkl}"
SEED="${SEED:-0}"
EXPERT_DEMOS="${EXPERT_DEMOS:-1}"
LEARN_STEPS="${LEARN_STEPS:-500000}"
EVAL_INTERVAL="${EVAL_INTERVAL:-10000}"
EVAL_EPS="${EVAL_EPS:-10}"
EXP_NAME="${EXP_NAME:-offline_iq_cheetah_no_penalty_1p5k_v1}"
...
"$PYTHON_BIN" train_iq.py \
  ...
  method.penalty=True \
  method.penalty_N=5 \
  method.dynamics_ckpt=dynamics/HalfCheetah-v2/ensemble_5.pt \
