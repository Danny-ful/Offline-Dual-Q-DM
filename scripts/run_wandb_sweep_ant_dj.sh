...
# Ant WandB Sweep Script for Offline-Dual-Q-DM-DJ
# Usage:
#   bash scripts/run_wandb_sweep_ant_dj.sh
...
SWEEP_CONFIG="${SWEEP_CONFIG:-scripts/wandb_sweep_ant_dj.yaml}"
SWEEP_LOG="${SWEEP_LOG:-scripts/sweep_ids_ant_dj.log}"
EXISTING_SWEEP_ID="${EXISTING_SWEEP_ID:-}"
AUTO_REUSE_SWEEP="${AUTO_REUSE_SWEEP:-1}"
SWEEP_STATE_FILE="${SWEEP_STATE_FILE:-scripts/.sweep_state_ant_dj.env}"
