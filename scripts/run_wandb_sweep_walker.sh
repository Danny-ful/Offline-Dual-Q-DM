...
# Usage:
#   bash scripts/run_wandb_sweep_walker.sh
...
SWEEP_CONFIG="${SWEEP_CONFIG:-scripts/wandb_sweep_walker.yaml}"
SWEEP_LOG="${SWEEP_LOG:-scripts/sweep_ids_walker.log}"
EXISTING_SWEEP_ID="${EXISTING_SWEEP_ID:-}"
AUTO_REUSE_SWEEP="${AUTO_REUSE_SWEEP:-1}"
SWEEP_STATE_FILE="${SWEEP_STATE_FILE:-scripts/.sweep_state_walker.env}"
