...
# Expert data paths
export EXPERT_PATH="/home/ubuntu/shengyifei/lwq/experts/halfcheetah.pkl"
export SUPPLEMENT_PATH="/home/ubuntu/shengyifei/lwq/supplement/halfcheetah_medium_expert-v2.pkl"
...
# Set WANDB API key
export WANDB_API_KEY="${WANDB_API_KEY:-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}"
...
SWEEP_CONFIG="${SWEEP_CONFIG:-scripts/wandb_sweep_halfch.yaml}"
SWEEP_LOG="${SWEEP_LOG:-scripts/sweep_ids_halfch.log}"
EXISTING_SWEEP_ID="${EXISTING_SWEEP_ID:-}"
AUTO_REUSE_SWEEP="${AUTO_REUSE_SWEEP:-1}"
SWEEP_STATE_FILE="${SWEEP_STATE_FILE:-scripts/.sweep_state_halfch.env}"
