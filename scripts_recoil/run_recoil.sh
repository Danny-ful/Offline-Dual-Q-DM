...
SWEEP_CONFIG="${SWEEP_CONFIG:-scripts_recoil/wandb_sweep_recoil.yaml}"
SWEEP_LOG="${SWEEP_LOG:-scripts_recoil/sweep_ids.log}"
EXISTING_SWEEP_ID="${EXISTING_SWEEP_ID:-}"
AUTO_REUSE_SWEEP="${AUTO_REUSE_SWEEP:-1}"
SWEEP_STATE_FILE="${SWEEP_STATE_FILE:-scripts_recoil/.sweep_state.env}"
