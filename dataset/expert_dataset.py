...
class ExpertDataset(Dataset):
    ...
    def __init__(self,
        ...
        self.trajectories = {}
        available_trajectories = len(all_trajectories["lengths"])
        requested_trajectories = num_trajectories
        num_trajectories = min(num_trajectories, available_trajectories)
        if requested_trajectories > available_trajectories:
            print(
                f"[ExpertDataset] Requested {requested_trajectories} trajectories, "
                f"but only {available_trajectories} are available in {expert_location}. "
                f"Using {num_trajectories}."
            )
